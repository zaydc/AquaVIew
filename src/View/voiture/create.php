<?php 
$pageTitle = 'AquaView - Ajouter une voiture';
...
<div class="relative min-h-screen text-white bg-slate-900 pt-20">
    ...
    <main class="relative z-10 max-w-2xl mx-auto px-6 py-12">
        <h1 class="text-4xl font-light mb-8">Ajouter une voiture</h1>
        ...
        <div class="p-8 rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10">
            <form action="?controller=voiture&action=create" method="POST" class="space-y-6">
                <div>
                    <label class="block text-sm font-medium text-white/70 mb-2">Marque</label>
                    <input type="text" name="marque" required
                           class="w-full px-4 py-3 rounded-lg bg-slate-800/50 border border-white/10 text-white placeholder-white/40 focus:border-cyan-400 focus:outline-none transition-colors" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="annee" required min="1900" max="2030"
                           class="w-full px-4 py-3 rounded-lg bg-slate-800/50 border border-white/10 text-white placeholder-white/40 focus:border-cyan-400 focus:outline-none transition-colors" />
                </div>
                <div>
